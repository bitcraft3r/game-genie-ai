export const conceptArr = [
    { type: "text", tokens: 256, slug: "idea", title: "Game Idea", description: "Generate a name and description for your next game", placeholder: "Describe your game. E.g. mmorpg, like world of warcraft, web3 and blockchain, free-to-play", prefix: "Generate a name and description of a game that includes the following:" },
...
export const storyArr = [
    { type: "text", tokens: 888, slug: "lore", title: "Lore", description: "Create an immersive lore for your game", placeholder: "Describe your game. E.g. MMORPG named Gemscape, where players collaborate in an open world, interoperable and community-owned.", prefix: "Create an immersive lore and origin story for my game:" },
...
export const contentArr = [
    ...
    { type: "text", tokens: 64, slug: "twitter", title: "Twitter Post", description: "Generate an engaging twitter post", placeholder: "Describe the post. E.g. Created stories and art for my web3 game on @GameGenieAi", prefix: "Create text for an engaging twitter post, and use relevant emojis sparingly, about:" },
    { type: "text", tokens: 512, slug: "thread", title: "Twitter Thread", description: "Generate an engaging twitter thread", placeholder: "Describe the twitter thread. E.g. Why game developers should use AI tools to tell better stories", prefix: "Create a twitter thread that is engaging, informational and educational. Describe each point in detail, and add a concrete example, numbers or statistics. Don't be repetitive. It is about:" },
]